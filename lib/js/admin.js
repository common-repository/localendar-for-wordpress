jQuery(document).ready(function($){
	...
	if ( $('.localendar-type-full').is(':checked') || $('.localendar-type-static').is(':checked')|| $('.localendar-type-iframe-responsive').is(':checked') ) {
		$('.localendar-link-text').hide();
	...
	$(document).on('change.localendarLink', '.localendar-types input[type="radio"]', function() {
		...
		if (( 'full' == $(this).val() && 'mb' == select_val) || ('static' == $(this).val() && 'mb' == select_val)|| ('iframe-responsive' == $(this).val() && 'mb' == select_val) ) {
			$('.localendar-iframe-style').hide();
			$('.localendar-link-text').hide();
			$('.select-style').show();
			$('.localendar-styles').show();
			$('.localendar-hide-events').show();
			$('.localendar-mini-style').hide();
		} else if ( ('full' == $(this).val() && 'mb' !== select_val) || ('static' == $(this).val() && 'mb' !== select_val) || ('iframe-responsive' == $(this).val() && 'mb' !== select_val)) {
			$('.localendar-hide-events').hide();
			$('.localendar-iframe-style').hide();
			$('.localendar-link-text').hide();
			$('.select-style').show();
