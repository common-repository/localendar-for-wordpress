...
Donate link: 
Tags: calendar, event, date, ical, events calendar
...
Thanks for checking out the [localendar](http://www.localendar.com) calendar plugin for WordPress. We have been powering web calendars for thousands of sites for over 16 years, and are pleased to provide a dedicated calendar plugin for WordPress.
...
Includes **Twitter integration**: Send event reminders as custom tweets.

Our new "School Year" view is perfect for schools and other venues that don't want to show a 12-month calendar

https://vimeo.com/230486304

= Calendar Features =

* Full event title display on all calendar views - **no trunctation!**
* Year/Month/Week/Day block and list views, "Today + Happening Soon", and a mini-calendar widget
...
= 1.3 =
* Support for new Year and School-Year view styles
* Removed deprecated calendar publish methods

= 1.2 =
* Support for responsive iframe style
* Protocol agnostic urls used to include localendar.com content
